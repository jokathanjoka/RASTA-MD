...
zokou({ nomCom: "wagroup", reaction: "😌", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    ...
    let z = 'best coder md \n\n👋Hello,,Click The link below to Join best coder md WhatsApp Testing Group\n\n';
    let d = 'https://whatsapp.com/channel/0029Vade9VgD38CPEnxfYF0M\n\nJoin the group and wait for updates from the admin,Thank you. \n\n\n> by joel kang'oma ';
    let varmess = z + d;
    var img = 'https://telegra.ph/file/56dfb94e0f8b32fab33a7.jpg';
...
zokou({ nomCom: "channel", reaction: "😌", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    console.log("Commande saisie !!!s");
    let z = 'BEST CODER MD\n\nHello👋,Click on the link below and follow best coder mdWhatsApp Channel for updates on this bot and other Tech related informations\n';
...
zokou({ nomCom: "test", reaction: "✅", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    console.log("Commande saisie !!!s");
    let z = ' *☹︎ BEST CODER-MD BOT IS CURRENTLY ACTIVE ☹︎*\n';
    let d = ' ❄︎ *_MADE ON EARTH BY BEST CODER TECH TEAM_* ❄︎';
    let varmess = z + d;
    var img = 'https://telegra.ph/file/56dfb94e0f8b32fab33a7.jpg';
    await zk.sendMessage(dest, { image: { url: img }, caption: varmess });
    //console.log("montest")
...
zokou({ nomCom: "version", reaction: "⏳", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    console.log("Commande saisie !!!s");
    let z = ' *YOU ARE CURRENTLY USING BEST CODER MD*\n\n';
